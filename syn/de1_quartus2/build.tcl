...
set_global_assignment -name VHDL_FILE $RTL_DIR/mcu/mcu80_pkg.vhdl
set_global_assignment -name VHDL_FILE $OBJ_CODE_DIR/obj_code_pkg.vhdl
set_global_assignment -name VHDL_FILE $RTL_DIR/mcu/mcu80_uart.vhdl
set_global_assignment -name VHDL_FILE $RTL_DIR/mcu/mcu80_irq.vhdl
set_global_assignment -name VHDL_FILE $RTL_DIR/mcu/mcu80.vhdl
set_global_assignment -name VHDL_FILE $RTL_DIR/light8080_ucode_pkg.vhdl
set_global_assignment -name VHDL_FILE $RTL_DIR/light8080.vhdl
set_global_assignment -name VHDL_FILE $BOARD_DIR/$PROJECT_TOP.vhdl
